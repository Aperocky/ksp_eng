...
FUNCTION TO_UNIT_VECTOR {
 ...
 FUNCTION AUTOPILOT_TO_WAYPOINT {
    ...
    LOCAL PITCHPID TO PIDLOOP(0.002, 0, 0.01, -1, 1).
...
FUNCTION LANDING {
    ...
    LOCAL PLOOP TO PIDLOOP(0.2, 0, 0.1, -5, 30).
    LOCK THROTTLE TO 0.
    LOCK STEERING TO ST.
    UNTIL ALT:RADAR < 1 {
        LOCAL TARGET_ALT TO MIN(200, (SHIP:GROUNDSPEED - 25) * 4).
